      ...
      if (struct.rowList != null) {
        if (struct.isSetRowList()) {
          oprot.writeFieldBegin(ROW_LIST_FIELD_DESC);
          {
            ...
            for (java.util.List<String> _iter10 : struct.rowList)
            {
              {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.columnsList = new java.util.ArrayList<String>(_list15.size);
          @org.apache.thrift.annotation.Nullable String _elem16;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.rowList = new java.util.ArrayList<java.util.List<String>>(_list18.size);
          @org.apache.thrift.annotation.Nullable java.util.List<String> _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            {
              org.apache.thrift.protocol.TList _list21 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
              _elem19 = new java.util.ArrayList<String>(_list21.size);
